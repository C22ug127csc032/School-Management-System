              ...
              <div className="relative z-10 flex h-full flex-col justify-between text-white">
                <div className="max-w-sm">
                  <div className="mb-6 flex justify-center lg:justify-start">
                    <div className="flex h-20 w-20 items-center justify-center overflow-hidden rounded-full border border-white/15 bg-white/10 text-3xl font-bold text-white sm:h-24 sm:w-24">
                      {String(welcomeTitle || 'S').charAt(0)}
                    </div>
                  </div>
