      ...
      <div className="mx-auto flex min-h-[calc(100vh-2rem)] max-w-6xl items-center justify-center sm:min-h-[calc(100vh-3rem)] lg:min-h-[calc(100vh-4rem)]">
        ...
        >
          <div className="grid lg:grid-cols-[1.02fr_0.98fr]">
            <section className="relative overflow-hidden bg-gradient-to-br from-primary-500 via-primary-600 to-sidebar px-6 py-7 sm:px-8 sm:py-9 lg:min-h-[620px] lg:px-12 lg:py-14">
