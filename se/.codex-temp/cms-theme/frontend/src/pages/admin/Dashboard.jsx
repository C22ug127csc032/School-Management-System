...
export default function Dashboard() {
  ...
  const hasFeesSummaryAccess = can('admin_payments_view', ['super_admin', 'admin', 'accountant']);
  const hasLibraryAccess = can('admin_library_manage', ['super_admin', 'admin', 'librarian']);
  const canManageStudents = can('admin_students_view', ['super_admin', 'admin', 'class_teacher', 'admission_staff']);
  const canCreateStudents = can('admin_students_create', ['super_admin', 'admin', 'admission_staff']);
  const canManageFees = can('admin_fee_assign', ['super_admin', 'admin', 'accountant']);
  const canManagePayments = can('admin_payments_view', ['super_admin', 'admin', 'accountant']);
  const canManageExpense = can('admin_expense_manage', ['super_admin', 'admin', 'accountant']);
  const canManageAttendance = can('admin_checkin_manage', ['super_admin', 'admin', 'class_teacher', 'hostel_warden']);
  const canManageLeave = can('admin_leave_manage', ['super_admin', 'admin', 'class_teacher', 'hostel_warden']);
  const canManageOutpass = can('admin_outpass_manage', ['super_admin', 'admin', 'class_teacher', 'hostel_warden']);
  const canManageInventory = can('admin_inventory_manage', ['super_admin', 'admin']);
  const canManageReports = can('admin_reports_view', ['super_admin', 'admin', 'accountant']);
  const canManageCirculars = can('admin_circular_manage', ['super_admin', 'admin', 'class_teacher']);
  const canManageStaff = can('admin_staff_manage', ['super_admin']);
