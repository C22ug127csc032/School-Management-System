...
const TABS = [
  { label: 'Overview', capability: 'admin_reports_tab_overview', fallbackRoles: ['super_admin', 'admin', 'accountant'] },
  { label: 'Fees', capability: 'admin_reports_tab_fees', fallbackRoles: ['super_admin', 'admin', 'accountant'] },
  { label: 'Payments', capability: 'admin_reports_tab_payments', fallbackRoles: ['super_admin', 'admin', 'accountant'] },
  { label: 'Expenses', capability: 'admin_reports_tab_expenses', fallbackRoles: ['super_admin', 'admin', 'accountant'] },
  { label: 'Inventory', capability: 'admin_reports_tab_inventory', fallbackRoles: ['super_admin', 'admin', 'accountant'] },
  { label: 'Library', capability: 'admin_reports_tab_library', fallbackRoles: ['super_admin', 'admin'] },
  { label: 'Shop & Canteen', capability: 'admin_reports_tab_shop', fallbackRoles: ['super_admin', 'admin'] },
  { label: 'Attendance', capability: 'admin_reports_tab_attendance', fallbackRoles: ['super_admin', 'admin'] },
];
