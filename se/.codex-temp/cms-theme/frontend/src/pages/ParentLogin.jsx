...
export default function ParentLogin() {
  ...
  const handleSendOTP = async () => {
    ...
    setSendingOTP(true);
    try {
      await api.post('/parent/send-otp', { phone });
        ...
        <form onSubmit={handlePasswordLogin} className="space-y-5">
          <div className="rounded-[1rem] border border-primary-100 bg-slate-50 p-4">
            <div className="mb-4 flex items-center justify-between gap-3 border-b border-primary-100 pb-3">
              ...
              <a href="/parent/register" className="shrink-0 text-xs font-semibold uppercase tracking-[0.08em] text-primary-600 hover:underline">
                Register
              </a>
            </div>
